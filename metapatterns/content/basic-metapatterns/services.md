...
### [Service\-Based Architecture]({{< relref "../extension-metapatterns/sandwich.md#service-based-architecture" >}}) \(SBA\), [Macroservices]({{< relref "#whole-subdomain-sub-domain-services-macroservices" >}})

...
description = "Monolith, Shards, Layers, Services, and Pipeline are the basic building blocks for any complex architecture."
...
[*Shards*]({{< relref "../basic-metapatterns/shards.md" >}}) are multiple instances of a [*Monolith*]({{< relref "../basic-metapatterns/monolith.md" >}})\. They are scalable but usually require an external component for coordination\.
...
<img src="/diagrams/Contents/Layers.png" alt="Layered architecture." loading="lazy" width="783" height="243" style="width:100%"/>
</picture>
</a>
</figure>
...
<img src="/diagrams/Contents/Services.png" alt="Services Architecture." loading="lazy" width="943" height="246" style="width:93%"/>
</picture>
</a>
</figure>
...
A [*Pipeline*]({{< relref "../basic-metapatterns/pipeline.md" >}}) is a kind of [*Services*]({{< relref "../basic-metapatterns/services.md" >}}) with unidirectional flow\. Each service implements a single step of data processing\. The system is flexible but may grow out of control\. 

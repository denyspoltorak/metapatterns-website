...
*Orchestration* – a kind of *workflow* where a single dedicated *component* \(*Orchestrator*\) makes use of \(usually multiple\) less *abstract components*\. *Facade* \[[GoF]({{< relref "../appendices/books-referenced.md#gof" >}})\] is a good example\.

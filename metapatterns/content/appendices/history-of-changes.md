...
1\.2 \(03\-2026\) – Replaced the boring *Combined Component* with [*Sandwich*]({{< relref "../extension-metapatterns/sandwich.md" >}})\. Added [*Cell*]({{< relref "../implementation-metapatterns/hexagonal-architecture.md#examples--cell" >}}), [*ECB*]({{< relref "../basic-metapatterns/layers.md#entity-control-boundary-ecb-entity-boundary-control-ebc-boundary-control-entity-bce" >}}), [*User Interface*]({{< relref "../extension-metapatterns/proxy.md#user-interface-presentation-layer-separated-presentation-command-line-interface-cli-graphical-user-interface-gui-frontend-human-machine-interface-hmi-man-machine-interface-mmi-operator-interface" >}}), [examples of *Plugins*]({{< relref "../implementation-metapatterns/plugins.md#examples" >}}), and [descriptions of layer roles]({{< relref "../basic-metapatterns/layers.md#variants-of-layer-roles" >}})\. Many minor changes\.
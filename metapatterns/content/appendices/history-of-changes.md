...
1\.2\.1 \(xx\-2026\) – Added sections on [read\-write separation]({{< relref "../analytics/comparison-of-architectural-patterns/the-multiform-read-write-separation.md" >}}) and [latency optimizations]({{< relref "../analytics/comparison-of-architectural-patterns/latency-optimizations-on-the-system-level.md" >}}), and [*Vertical Slice Architecture*]({{< relref "../extension-metapatterns/sandwich.md#vertical-slice-architecture-vsa" >}})\.
...
1\.2 \(05\-2026\) – New chapters: [System topologies]({{< relref "../introduction/system-topologies.md" >}}) and [*Sandwich*]({{< relref "../extension-metapatterns/sandwich.md" >}}) \(replaced the boring *Combined Component*\)\. Added [*Cell*]({{< relref "../implementation-metapatterns/hexagonal-architecture.md#cell-cluster-domain" >}}), [*ECB*]({{< relref "../basic-metapatterns/layers.md#entity-control-boundary-ecb-entity-boundary-control-ebc-boundary-control-entity-bce" >}}), [*User Interface*]({{< relref "../extension-metapatterns/proxy.md#user-interface-presentation-layer-separated-presentation-command-line-interface-cli-graphical-user-interface-gui-frontend-human-machine-interface-hmi-man-machine-interface-mmi-operator-interface" >}}), [*Pedestal*]({{< relref "../implementation-metapatterns/hexagonal-architecture.md#pedestal" >}}), [examples of *Plugins*]({{< relref "../implementation-metapatterns/plugins.md#examples" >}}), and [descriptions of layer roles]({{< relref "../basic-metapatterns/layers.md#variants-of-layer-roles" >}})\. Changed the diagram for [*Hexagonal Architecture*]({{< relref "../implementation-metapatterns/hexagonal-architecture.md" >}})\. Made many minor alterations\. The book passed another cycle of editing\.

1\.2\.1 \(08\-2026\) – Added sections on [read\-write separation]({{< relref "../analytics/comparison-of-architectural-patterns/the-multiform-read-write-separation.md" >}}) and [latency optimizations]({{< relref "../analytics/comparison-of-architectural-patterns/latency-optimizations-on-the-system-level.md" >}}), and [*Vertical Slice Architecture*]({{< relref "../extension-metapatterns/sandwich.md#vertical-slice-architecture-vsa" >}})\. Lowercased components named after pattern instances \(orchestrators, adapters, meshes, etc\.\) to make the text easier to read\.
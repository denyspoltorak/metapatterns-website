...
Our touching on a single topology revealed a web of twenty or so pattern names that spreads all around\. With such a pace there is a hope of exploring the whole fabric which is known as *pattern language* \[[GoF]({{< relref "../appendices/books-referenced.md#gof" >}}), [POSA1]({{< relref "../appendices/books-referenced.md#posa1" >}}), [POSA2]({{< relref "../appendices/books-referenced.md#posa2" >}}), [POSA5]({{< relref "../appendices/books-referenced.md#posa5" >}})\]\.

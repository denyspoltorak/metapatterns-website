...
description = "The classification of architectural patterns into metapatterns is applied to compare them and reveal how various architectures approach certain problems."
...
<img src="/diagrams/Web/Sharing.png" alt="Two services with private databases and one database shared by the services." loading="lazy" width="263" height="263"/>
...
<img src="/diagrams/Web/Pipelineliness.png" alt="A client passes data to a service, which passes it to its database, which passes it to another service's database, from which it goes to the other service, and back to the client." loading="lazy" width="263" height="263"/>
...
<img src="/diagrams/Web/DI.png" alt="Polymorphic device drivers in an operating system." loading="lazy" width="262" height="263"/>
...
<img src="/diagrams/Web/Indirection.png" alt="A client accessing a service through an adapter." loading="lazy" width="263" height="263"/>

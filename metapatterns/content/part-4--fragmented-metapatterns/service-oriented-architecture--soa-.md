...
That removes the largest and most obvious part of the fragmentation, making the [*ESB*]({{< relref "../part-3--extension-metapatterns/combined-component.md#enterprise-service-bus-esb" >}}) \(if you use one\) [*orchestrate*]({{< relref "../part-1--foundations/arranging-communication.md#orchestration" >}}) only the *entity* layer\.

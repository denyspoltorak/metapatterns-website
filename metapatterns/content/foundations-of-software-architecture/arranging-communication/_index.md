...
description = "The components of a software system can be integrated through orchestration, choreography, or shared data. Each approach has benefits and drawbacks."
...
<img src="/diagrams/Communication/Monolith%20to%20Services.png" alt="A monolithic system is subdivided into several services but it is an open question how the resulting components interact." loading="lazy" width="1062" height="227" style="width:100%"/>
</picture>
</a>
</figure>
...
<img src="/diagrams/Web/Orchestration.png" alt="A client that calls an orchestrator which calls three services one by one." loading="lazy" width="263" height="286"/>
...
<img src="/diagrams/Web/Shared%20data.png" alt="A client communicating with a service which writes to a shared data layer, causing data processing by two other services." loading="lazy" width="263" height="287"/>
